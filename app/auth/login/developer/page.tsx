    ...
    <div className='flex flex-col md:flex-row justify-between'>
        ...
        <div className='w-full lg:w-5/12 flex items-center lg:h-screen px-12 py-14'>
            <div className="contianer mx-auto w-full">
                ...
                <h4 className='text-2xl font-bold'>Login to your account</h4>
                <p className='mt-4 text-sm'>It's nice to see you again. Ready to code?</p>
                <form onSubmit={handleSubmit(onSubmit)} className='mt-5'>
                    <div className="w-full lg:w-11/12">
                        <div className="">
                            <input {...register("email", {required:"This field is required"})} className="border-[1px] border-[#aaaaaa] px-4 py-[6.9px] rounded-md mt-1 w-full" type="text" placeholder="Enter your username or email"/>
                ...
                <div className='w-full lg:w-11/12 mt-8'>
                    ...
                    <div className='text-center mt-12'>
                        <Link href="/auth/register/developer">Don't have an account?
                        Sign up</Link>
                    </div>
                </div>
            </div>
