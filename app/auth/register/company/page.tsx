                    ...
                    <div className="w-full lg:w-11/12 bg-[#000] p-5 rounded-xl">
                        ...
                        <div className='flex items-center justify-between w-full '>
                            <div className="mt-[-20px] w-6/12">
                                ...
                                <p className="text-red-300  h-10 text-xs">{errors.fname && String(errors.fname?.message)}</p>
                            </div>
                            <div className="mt-[-20px] w-6/12 ml-2">
                                ...
                                <p className="text-red-300  h-10 text-xs">{errors.lname && String(errors.lname?.message)}</p>
                            </div>
                        </div>
                        <div className='flex items-center justify-between w-full '>
                            <div className="mt-[-20px] w-6/12">
                                ...
                                <p className="text-red-300  h-10 text-xs">{errors.cname &&  String(errors.cname?.message)}</p>
                            </div>
                            <div className="mt-[-20px] w-6/12 ml-2">
                                ...
                                <p className="text-red-300  h-10 text-xs">{errors.jobtitle &&String(errors.jobtitle?.message)}</p>
                            </div>
                        </div>
                        <div className='flex items-center justify-between w-full '>
                            <div className="mt-[-20px] w-6/12">
                                ...
                                <p className="text-red-300  h-10 text-xs">{errors.phone && String(errors.phone?.message)}</p>
                            </div>
                            <div className="mt-[-20px] w-6/12 ml-2">
                                <label>Country</label>
                                ...
                                <p className="text-red-300  h-10 text-xs">{errors.country && String(errors.country?.message)}</p>
                            </div>
                        </div>
                        <div className="mt-[-20px]">
